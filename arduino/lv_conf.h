...
#define LV_USE_DRAW_SW 1
    ...
    /* MUST be 1: lv_obj_set_style_clip_corner creates ARGB8888 layers for
     * rounded-corner clipping. Without this, children inside clip_corner
     * objects (like the RPM card) render empty in the corner regions. */
